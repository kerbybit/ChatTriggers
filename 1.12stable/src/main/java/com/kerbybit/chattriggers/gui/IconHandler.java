            ...
            if (isPotion(get_name.toLowerCase())) {
                ...
                if (potion != null) {
                    if (get_name.equalsIgnoreCase("health boost")) {
                        drawPotionIcon(x + Minecraft.getMinecraft().fontRenderer.getStringWidth(before_value)+4, y-1, Potion.getPotionById(10));
                        drawPotionIcon(x + Minecraft.getMinecraft().fontRenderer.getStringWidth(before_value)+2, y-1, Potion.getPotionById(10));
                        drawPotionIcon(x + Minecraft.getMinecraft().fontRenderer.getStringWidth(before_value), y-1, Potion.getPotionById(10));
                    } else if (get_name.equalsIgnoreCase("saturation")) {
                        return drawIcons(input.replace("{icon["+get_name+"]}", "{icon[golden_carrot]}"), x, y);
                    } else {
                        drawPotionIcon(x + Minecraft.getMinecraft().fontRenderer.getStringWidth(before_value)+2, y-1, potion);
                    }
                }
            } else {
                ...
                if (item != null) {
                    drawItemIcon(x + Minecraft.getMinecraft().fontRenderer.getStringWidth(before_value), y-4, itemStack);
