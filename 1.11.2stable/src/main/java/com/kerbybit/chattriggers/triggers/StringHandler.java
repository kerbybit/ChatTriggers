	...
	static String builtInStrings(String TMP_e, ClientChatReceivedEvent chatEvent) {
		...
		if (chatEvent!=null) {
            if (TMP_e.contains("{msg}.meta().clickEvent().action()")) {
                String tmp = chatEvent.getMessage().getStyle().toString();
		...
		if (TMP_e.contains("{me}")) {
			...
			temporary.add(Minecraft.getMinecraft().player.getDisplayNameString());
			global.TMP_string.add(temporary);
			global.backupTMP_strings.add(temporary);
		...
		if (TMP_e.contains("{sneak}")) {
			...
			temporary.add(Minecraft.getMinecraft().player.isSneaking()+"");
			global.TMP_string.add(temporary);
			global.backupTMP_strings.add(temporary);
		...
		if (TMP_e.contains("{coordx}") || TMP_e.contains("{x}")) {
			...
			temporary.add(Math.round(Minecraft.getMinecraft().player.posX)+"");
			global.TMP_string.add(temporary);
			global.backupTMP_strings.add(temporary);
		...
		if (TMP_e.contains("{coordy}") || TMP_e.contains("{y}")) {
			...
			temporary.add(Math.round(Minecraft.getMinecraft().player.posY)+"");
			global.TMP_string.add(temporary);
			global.backupTMP_strings.add(temporary);
		...
		if (TMP_e.contains("{coordz}") || TMP_e.contains("{z}")) {
			...
			temporary.add(Math.round(Minecraft.getMinecraft().player.posZ)+"");
			global.TMP_string.add(temporary);
			global.backupTMP_strings.add(temporary);
