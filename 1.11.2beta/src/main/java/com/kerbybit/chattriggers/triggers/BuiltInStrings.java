    ...
    public static String builtInStrings(String TMP_e, ClientChatReceivedEvent chatEvent) {
        ...
        if (chatEvent!=null) {
            ...
            if (TMP_e.contains("{msg}")) {
                TMP_e = createDefaultString("msg", ChatHandler.removeFormatting(chatEvent.getMessage().getFormattedText()), TMP_e);
            }
        }
        ...
        if (TMP_e.contains("{me}")) {
            TMP_e = createDefaultString("me", Minecraft.getMinecraft().player.getDisplayNameString(), TMP_e);
        }
        ...
        if (TMP_e.contains("{sneak}")) {
            TMP_e = createDefaultString("sneak", Minecraft.getMinecraft().player.isSneaking()+"", TMP_e);
        }
        ...
        if (TMP_e.contains("{coordx}") || TMP_e.contains("{x}")) {
            TMP_e = createDefaultString("coordx", "x", Math.round(Minecraft.getMinecraft().player.posX)+"", TMP_e);
        }
        if (TMP_e.contains("{coordy}") || TMP_e.contains("{y}")) {
            TMP_e = createDefaultString("coordy", "y", Math.round(Minecraft.getMinecraft().player.posY)+"", TMP_e);
        }
        if (TMP_e.contains("{coordz}") || TMP_e.contains("{z}")) {
            TMP_e = createDefaultString("coordz", "z", Math.round(Minecraft.getMinecraft().player.posZ)+"", TMP_e);
        }
        ...
        if (TMP_e.contains("{facing}")) {
            TMP_e = createDefaultString("facing", Minecraft.getMinecraft().player.getHorizontalFacing().toString(), TMP_e);
        }
        ...
        if (TMP_e.contains("{armor}")) {
            ...
            for (int i=armor_set.size()-1; i>=0; i--) {
                ...
                if (armor != null) {
                    ...
                    if (armor.getItem().getRegistryName() != null) {
