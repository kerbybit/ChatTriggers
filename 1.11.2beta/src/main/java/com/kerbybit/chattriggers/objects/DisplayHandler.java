...
public class DisplayHandler {
    ...
    public static void drawRect(double left, double top, double right, double bottom, int color) {
        ...
        vertexbuffer.pos(left+1, bottom-1, 0.0D).endVertex();
        vertexbuffer.pos(right-1, bottom-1, 0.0D).endVertex();
        vertexbuffer.pos(right-1, top-1, 0.0D).endVertex();
        vertexbuffer.pos(left+1, top-1, 0.0D).endVertex();
        tessellator.draw();
